...
DataTable["RiemannHypothesisFormulation", "Entity"] = {
	...
	*)
	...
	"SekatskiiBeltraminelliMerliniExtensionA" -> {
		...
		"StatementFormulation" -> Function[{t, \[FormalB]},
		ForAll[\[FormalB], \[FormalB] \[Element] Reals && 1 > \[FormalB] >= 1/2,
		Equivalent[\[FormalB], Element[\[FormalB], Reals] && \[FormalB] >= 1/2 && \[FormalB] < 1,
				Divide[1,2 Pi] Inactive[Integrate][
					Divide[Log[Zeta[\[FormalB] + I t]], (\[FormalB] + I t)^2],
					{t, - Infinity, Infinity}, PrincipalValue -> True
				] == 1 - Divide[1, \[FormalB]],
		!Exists[\[FormalZ], \[FormalZ] \[Element] Complexes, Zeta[\[FormalZ]] == 0 && Re[\[FormalZ]] > \[FormalB]]
		]]],
		"Classes" -> {"Integral"},
	...
	"SekatskiiBeltraminelliMerliniExtensionB" -> {
		...
		"StatementFormulation" -> Function[ForAll[b, b \[Element] Reals && 1 > b >= 1/2,
		Equivalent[
		Divide[1,2 Pi] Inactive[Integrate][
					Divide[Log[Zeta[z](z-1)], z^2],
				{z, b - I Infinity, b + I Infinity}, PrincipalValue -> True] == 0,
		!Exists[z, z \[Element] Complexes, Zeta[z] == 0 && Re[z] > b]
		]]],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Extension",
		"FormulationDate" -> 2012,
	...
	"SekatskiiBeltraminelliMerliniExtensionC" -> {
		...
		"StatementFormulation" -> Function[{t, a, b},
		ForAll[{a,b}, a \[Element] Reals && a > 0 && b \[Element] Reals && a+b != 1 && 1 > b >= 1/2,
		Equivalent[
		Divide[a, Pi] Inactive[Integrate][
				Divide[Log[Abs[Zeta[b+I t]]], a^2 + t^2],
				{t, - Infinity, Infinity}, PrincipalValue -> True
			] == Log[Abs[Divide[(a + b -1) Zeta[a+b],a - b +1]]],
		!Exists[z, z \[Element] Complexes, Zeta[z] == 0 && Re[z] > b]
		]]],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Extension",
	...
	"SekatskiiBeltraminelliMerliniExtensionD" -> {
		...
		"StatementFormulation" -> Function[{t, b,c,d},
		ForAll[{b,c,d}, b \[Element] Reals && c \[Element] Reals && d \[Element] Reals && c > 0&& d >0 && c d <= 3.2*10^19 && 1 > b >= 1/2 && b+c!= 1 && b+d!= 1,
		Equivalent[
		Inactive[Integrate][
	...
	"SekatskiiBeltraminelliMerliniExtensionF" -> {
		...
		"StatementFormulation" -> Function[{t, b, c},
		ForAll[{b, c}, b \[Element] Reals && c \[Element] Reals && c > 0 && c(1-b) <= 3.2*10^19 && 1 > b >= 1/2 && b+c!= 1,
		Equivalent[
		Inactive[Integrate][
				Divide[t Arg[Zeta[b + I t]], (c^2+t^2)((1-b)^2+t^2)],
				{t, 0, Infinity}
			] == Divide[Pi, 2(c^2 - (1-b)^2)] * Log[Abs[Divide[(c^2-(1-b)^2)(1-b)Zeta[b+c], 2c^2]]],
		!Exists[z, z \[Element] Complexes, Zeta[z] == 0 && Re[z] > b]
		]]],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Extension",
	...
	"SekatskiiBeltraminelliMerliniExtensionH" -> {
		...
		"StatementFormulation" -> Function[{t, b},
		ForAll[{b}, b \[Element] Reals && 1 > b >= 1/2,
		Equivalent[
		Inactive[Integrate][
	...
	"SekatskiiBeltraminelliMerliniExtensionJ" -> {
		...
		"StatementFormulation" -> Function[{t, a, b, n},
		ForAll[{a, b}, a \[Element] Reals && b \[Element] Reals && a>0 && a(1-b) <= Divide[Pi,2] && 1 > b >= 1/2,
		Equivalent[
		Divide[a, Pi] Inactive[Integrate][
	...
	"SekatskiiBeltraminelliMerliniExtensionL" -> {
		...
		"StatementFormulation" -> Function[{t, a, b, x},
		ForAll[{a, b}, a \[Element] Reals && b \[Element] Reals && a>0 && a(1-b) <= Pi && 1 > b >= 1/2,
		Equivalent[
		Inactive[Integrate][
	...
	"SekatskiiBeltraminelliMerliniExtensionN" -> {
		...
		ForAll[{b}, b \[Element] Reals && 1 > b >= 1/2,
		Equivalent[
		Divide[1-b, Pi] Inactive[Integrate][
	...
	"SekatskiiBeltraminelliMerliniExtensionO" -> {
		...
		"StatementFormulation" -> Function[{t, a, b, n, x},
			ForAll[{a, b, n}, a \[Element] Reals && a > 0 && b \[Element] Reals && N \[Element] Integers && 1/4 >= b > 0 && a = Divide[Pi(2n+1), 1-2b] && n <= 1/(4b)-1,
			Equivalent[
			Inactive[Integrate][
				Exp[- a t]Log[Abs[Zeta[b+I t]]],
				{t, 0, Infinity}]
