...
DataTable["RiemannHypothesisFormulation", "Entity"] = {
	...
	*)
	...
	"SekatskiiBeltraminelliMerliniFormulationA" -> {
		...
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Equivalent",
		"Formulators" -> {"SekatskiiBeltraminelliMerlini::?????"},
			(* On equalities involving integrals of the logarith of the Riemann zeta-function and equivalent to the Riemann Hypothesis *)
			(* Ukrainian Mathematical Journal, Vol. 64, No. 2, July, 2012 (Ukrainian Original Vol. 64, No. 2, January, 2012) *)
	...
	"SekatskiiBeltraminelliMerliniFormulationL" -> {
		...
		"RelationshipToRiemannHypothesis" -> "Equivalent",
		"Formulators" -> {"SekatskiiBeltraminelliMerlini::?????"},
			(* On Equalities Involving Integrals of the Logarithm of the Riemann \:d835\:df0d-Function with Exponential Weight Which Are Equivalent to the Riemann Hypothesis *)
			(* International Journal of Analysis, Volume 2015, Article ID 980728, 8 pages *)
	...
	"SekatskiiBeltraminelliMerliniExtensionL" -> {
		...
		"RelationshipToRiemannHypothesis" -> "Extension",
		"Formulators" -> {"SekatskiiBeltraminelliMerlini::?????"},
			(* On Equalities Involving Integrals of the Logarithm of the Riemann zeta-Function with Exponential Weight Which Are Equivalent to the Riemann Hypothesis *)
			(* International Journal of Analysis, Volume 2015, Article ID 980728, 8 pages *)
		"FormulationDate" -> 2015,
		"References" -> {
			{"SBM2012"}
