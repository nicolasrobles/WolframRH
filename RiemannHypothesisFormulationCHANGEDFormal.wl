...
DataTable["RiemannHypothesisFormulation", "Entity"] = {
	...
	"BalazardSaiasYorFormulation" -> {
		...
		"StatementFormulation" -> Function[{t},
			Inactive[Integrate][
				...
				{t, -Infinity, Infinity}, PrincipalValue -> True
			] == 0
		],
		"Classes" -> {"Integral"},
	...
	"GrommerFormulation" -> {
		...
		"StatementFormulation" -> Function[{t, s1, sn}, (* TODO: Quantify n *) (* MENTIONTO: nicR: Evaluate in-product to test *)
			"Let M[n] be the matrix whose entry i, j is s[i+j] coming from the Laurent expansion" Series[-Divide[RiemannXi'[t], RiemannXi[t]],{t, 0, n}]  "Then" Det[M[n]] > 0
		],*)
		"Classes" -> {"Matrix"},
		"RelationshipToRiemannHypothesis" -> "Equivalent",
		"Formulators" -> {},
		"FormulationDate" -> 1914,
		"References" -> {
			"Grommer1914"
		}
	},
	...
	*)
	...
	"SekatskiiBeltraminelliMerliniFormulationB" -> {
		...
		"StatementFormulation" -> Function[{z},
			Divide[1,2 Pi] Inactive[Integrate][
				...
				{z, Divide[1,2] - I Infinity, Divide[1,2] + I Infinity}, PrincipalValue -> True
			] == 0
		],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Equivalent",
	...
	"SekatskiiBeltraminelliMerliniFormulationD" -> {
		...
		"StatementFormulation" -> Function[{t, c, d},
			ForAll[c d <= 3.2 * 10^(19), c != d && c != Divide[1,2] && d != Divide[1,2], Inactive[Integrate][
				Divide[t Arg[Zeta[Divide[1,2] + I t]], (c^2+t^2)(d^2+t^2)],
				{t, 0, Infinity}
			] == Divide[Pi, 2(d^2 - c^2)] * Log[Abs[Divide[Zeta[Divide[1,2]+d],Zeta[Divide[1,2]+c]]]] + Divide[Pi, 2(d^2 - c^2)] * Log[Abs[Divide[(d^2-Divide[1,4])c^2,(c^2-Divide[1,4])d^2]]]
		]],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Equivalent",
		"FormulationDate" -> 2012,
	...
	"SekatskiiBeltraminelliMerliniFormulationF" -> {
		...
		"StatementFormulation" -> Function[{t, c},
	...
	"SekatskiiBeltraminelliMerliniFormulationK" -> {
		...
		"StatementFormulation" -> Function[{t, n},
			Inactive[Integrate][
				Divide[Log[Abs[Zeta[Divide[1,2]+ I t]]], Cosh[Pi t]],
				{t, 0, Infinity}, "PrincipalValue" -> True
			] == Log[Divide[Pi, 2]] + Inactive[Sum][(-1)^(n+1) Log[Zeta[n]], {n , 2, Infinity}]
		],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Equivalent",
		"FormulationDate" -> 2012,
	...
	"SekatskiiBeltraminelliMerliniFormulationL" -> {
		...
		"StatementFormulation" -> Function[{t, x, a},
			ForAll[a > 0 && a < 2 Pi, 
				Inactive[Integrate][
				...
				{x, 0, Infinity}, PrincipalValue -> True]
				+
	...
	"SekatskiiBeltraminelliMerliniFormulationM" -> {
		...
		"StatementFormulation" -> Function[{t, x, a},
			ForAll[a > 0 && a <= Pi, 
				Inactive[Integrate][
				Exp[- a t]Arg[Zeta[Divide[1,2]+I t]],
				{t, 0, Infinity}]
				- 
				Inactive[Integrate][
	...
	"SekatskiiBeltraminelliMerliniExtensionA" -> {
		...
		"StatementFormulation" -> Function[{\[FormalT], \[FormalB], \[FormalZ]},
		ForAll[\[FormalB], Element[\[FormalB], Reals] && 1 > \[FormalB] >= 1/2,
		Equivalent[\[FormalB], Element[\[FormalB], Reals] && \[FormalB] >= 1/2 && \[FormalB] < 1,
				Divide[1,2 Pi] Inactive[Integrate][
					Divide[Log[Zeta[\[FormalB] + I \[FormalT]]], (\[FormalB] + I \[FormalT])^2],
					{\[FormalT], - Infinity, Infinity}, PrincipalValue -> True
				] == 1 - Divide[1, \[FormalB]],
		!Exists[\[FormalZ], Element[\[FormalZ], Complexes], Zeta[\[FormalZ]] == 0 && Re[\[FormalZ]] > \[FormalB]]
		]]],
		"Classes" -> {"Integral"},
	...
	"SekatskiiBeltraminelliMerliniExtensionB" -> {
		...
		"StatementFormulation" -> Function[{\[FormalZ], \[FormalB], \[FormalS]}, 
		ForAll[\[FormalB], Element[\[FormalB], Reals] && 1 > \[FormalB] >= 1/2,
		Equivalent[
		Divide[1,2 Pi] Inactive[Integrate][
					Divide[Log[Zeta[\[FormalS]](\[FormalS]-1)], \[FormalS]^2],
				{\[FormalS], \[FormalB] - I Infinity, \[FormalB] + I Infinity}, PrincipalValue -> True] == 0,
		!Exists[\[FormalZ], Element[\[FormalZ], Complexes], Zeta[\[FormalZ]] == 0 && Re[\[FormalZ]] > \[FormalB]]
		]]],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Extension",
	...
	"SekatskiiBeltraminelliMerliniExtensionC" -> {
		...
		"StatementFormulation" -> Function[{\[FormalT], \[FormalA], \[FormalB], \[FormalZ]},
		ForAll[{\[FormalA], \[FormalB]}, Element[\[FormalA], Reals] && \[FormalA] > 0 && Element[\[FormalB], Reals] && \[FormalA] + \[FormalB] != 1 && 1 > \[FormalB] >= 1/2,
		Equivalent[
		Divide[\[FormalA], Pi] Inactive[Integrate][
				Divide[Log[Abs[Zeta[\[FormalB] + I \[FormalT]]]], \[FormalA]^2 + \[FormalT]^2],
				{\[FormalT], - Infinity, Infinity}, PrincipalValue -> True
			] == Log[Abs[Divide[(\[FormalA] + \[FormalB] -1) Zeta[\[FormalA] + \[FormalB]], \[FormalA] - \[FormalB] +1]]],
		!Exists[\[FormalZ], Element[\[FormalZ], Complexes], Zeta[\[FormalZ]] == 0 && Re[\[FormalZ]] > \[FormalB]]
		]]],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Extension",
	...
	"SekatskiiBeltraminelliMerliniExtensionD" -> {
		...
		"StatementFormulation" -> Function[{\[FormalT], \[FormalB], \[FormalC], \[FormalD], \[FormalZ]},
		ForAll[{\[FormalB], \[FormalC], \[FormalD]}, Element[\[FormalB], Reals] && Element[\[FormalC], Reals] && Element[\[FormalD], Reals] && \[FormalC] > 0&& \[FormalD] >0 && \[FormalC] \[FormalD] <= 3.2*10^19 && 1 > \[FormalB] >= 1/2 && \[FormalB] + \[FormalC] != 1 && \[FormalB] + \[FormalD] != 1,
		Equivalent[
		Inactive[Integrate][
				Divide[\[FormalT] Arg[Zeta[\[FormalB] + I \[FormalT]]], (\[FormalC]^2 + \[FormalT]^2)(\[FormalD]^2 + \[FormalT]^2)],
				{\[FormalT], 0, Infinity}
			] == Divide[Pi, 2(\[FormalD]^2 - \[FormalC]^2)] * Log[Abs[Divide[Zeta[\[FormalB] + \[FormalD]],Zeta[\[FormalB] + \[FormalC]]]]] + Divide[Pi, 2(\[FormalD]^2 - \[FormalC]^2)] * Log[Abs[Divide[(\[FormalD]^2 -(1 - \[FormalB]^2))\[FormalC]^2,(\[FormalC]^2 - (1-\[FormalB])^2)\[FormalD]^2]]],
		!Exists[\[FormalZ], Element[\[FormalZ], Complexes], Zeta[\[FormalZ]] == 0 && Re[\[FormalZ]] > \[FormalB]]
		]]],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Extension",
	...
	"SekatskiiBeltraminelliMerliniExtensionF" -> {
		...
		"StatementFormulation" -> Function[{\[FormalT], \[FormalB], \[FormalC], \[FormalZ]},
		ForAll[{\[FormalB], \[FormalC]}, Element[\[FormalB], Reals] && Element[\[FormalC], Reals] && \[FormalC] > 0 && \[FormalC](1 - \[FormalB]) <= 3.2*10^19 && 1 > \[FormalB] >= 1/2 && \[FormalB] + \[FormalC] != 1,
		Equivalent[
		Inactive[Integrate][
				Divide[\[FormalT] Arg[Zeta[\[FormalB] + I \[FormalT]]], (\[FormalC]^2 + \[FormalT]^2)((1 - \[FormalB])^2 + \[FormalT]^2)],
				{\[FormalT], 0, Infinity}
			] == Divide[Pi, 2(\[FormalC]^2 - (1 - \[FormalB])^2)] * Log[Abs[Divide[(\[FormalC]^2 - (1 - \[FormalB])^2)(1 - \[FormalB])Zeta[\[FormalB] + \[FormalC]], 2\[FormalC]^2]]],
		!Exists[\[FormalZ], Element[\[FormalZ], Complexes], Zeta[\[FormalZ]] == 0 && Re[\[FormalZ]] > \[FormalB]]
		]]],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Extension",
	...
	"SekatskiiBeltraminelliMerliniExtensionH" -> {
		...
		Equivalent[
		Inactive[Integrate][
				Divide[\[FormalT] Arg[Zeta[\[FormalB] + I \[FormalT]]], ((1 - \[FormalB])^2 + \[FormalT]^2)^2],
				{\[FormalT], 0, Infinity}
			] == Divide[Pi, 4(1 - \[FormalB])] * (EulerGamma - Divide[3, 2(1 - \[FormalB])]),
		!Exists[\[FormalZ], Element[\[FormalZ], Complexes], Zeta[\[FormalZ]] == 0 && Re[\[FormalZ]] > \[FormalB]]
		]]],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Extension",
	...
	"SekatskiiBeltraminelliMerliniExtensionJ" -> {
		...
		"StatementFormulation" -> Function[{\[FormalT], \[FormalA], \[FormalB], \[FormalN], \[FormalZ]},
		ForAll[{\[FormalA], \[FormalB]}, Element[\[FormalA], Reals] && Element[\[FormalB], Reals] && \[FormalA] > 0 && \[FormalA](1 - \[FormalB]) <= Divide[Pi, 2] && 1 > \[FormalB] >= 1/2,
		Equivalent[
		Divide[\[FormalA], Pi] Inactive[Integrate][
				Divide[Log[Abs[Zeta[\[FormalB] + I \[FormalT]]]], Cosh[\[FormalA] \[FormalT]]],
				{\[FormalT], 0, Infinity}, PrincipalValue -> True
			] == Divide[1, 2] Log[Divide[1 - Sin[\[FormalA](1 - \[FormalB])], 1 + Sin[\[FormalA](1 - \[FormalB])]]] + Inactive[Sum][(-1)^\[FormalN] Log[Zeta[\[FormalB] + Divide[Pi, 2\[FormalA]] + Divide[Pi \[FormalN], \[FormalA]]]], {\[FormalN], 0, Infinity}],
		!Exists[\[FormalZ], Element[\[FormalZ], Complexes], Zeta[\[FormalZ]] == 0 && Re[\[FormalZ]] > \[FormalB]]
		]]],
		"Classes" -> {"Integral"},
		"RelationshipToRiemannHypothesis" -> "Extension",
	...
	"SekatskiiBeltraminelliMerliniExtensionL" -> {
		...
		"StatementFormulation" -> Function[{\[FormalT], \[FormalA], \[FormalB], \[FormalX], \[FormalZ]},
		ForAll[{\[FormalA], \[FormalB]}, Element[\[FormalA], Reals] && Element[\[FormalB], Reals] && \[FormalA] > 0 && \[FormalA](1 - \[FormalB]) <= Pi && 1 > \[FormalB] >= 1/2,
		Equivalent[
		Inactive[Integrate][
				Exp[- \[FormalA] \[FormalT]]Log[Abs[Zeta[\[FormalB] + I \[FormalT]]]],
				{\[FormalT], 0, Infinity}, PrincipalValue -> True]
				- 
				Inactive[Integrate][
				Sin[\[FormalA] \[FormalX]]Log[Abs[Zeta[\[FormalB] + \[FormalX]]]],
				{\[FormalX], 0, Infinity}, PrincipalValue -> True]
				+
				Divide[Pi, \[FormalA]] Sin[\[FormalA](1 - \[FormalB])]
				 == 0,
		!Exists[\[FormalZ], Element[\[FormalZ], Complexes], Zeta[\[FormalZ]] == 0 && Re[\[FormalZ]] > \[FormalB]]
		]]],
		"Classes" -> {"Integral"},
	...
	"SekatskiiBeltraminelliMerliniExtensionM" -> {
		...
		Equivalent[
		Inactive[Integrate][
				Exp[- \[FormalA] \[FormalT]]Arg[Zeta[\[FormalB] + I \[FormalT]]],
				{\[FormalT], 0, Infinity}]
				- 
				Inactive[Integrate][
				Cos[\[FormalA] \[FormalX]]Log[Abs[Zeta[\[FormalB] + \[FormalX]]]],
				{\[FormalX], 0, Infinity}, PrincipalValue -> True]
				+
				Divide[Pi, \[FormalA]] (1 - Cos[\[FormalA](1 - \[FormalB])])
				 == 0,
		!Exists[\[FormalZ], Element[\[FormalZ], Complexes], Zeta[\[FormalZ]] == 0 && Re[\[FormalZ]] > \[FormalB]]
		]]],
		"Classes" -> {"Integral"},
	...
	"SekatskiiBeltraminelliMerliniExtensionN" -> {
		...
		ForAll[{\[FormalB]}, Element[\[FormalB], Reals] && 1 > \[FormalB] >= 1/2,
		Equivalent[
		Divide[1 - \[FormalB], Pi] Inactive[Integrate][
				Divide[Log[Abs[Zeta[\[FormalB] + I \[FormalT]]]], (1 - \[FormalB])^2 + \[FormalT]^2],
				{\[FormalT], - Infinity, Infinity}, PrincipalValue -> True
			] == -Log[2 - 2\[FormalB]],
		!Exists[\[FormalZ], Element[\[FormalZ], Complexes], Zeta[\[FormalZ]] == 0 && Re[\[FormalZ]] > \[FormalB]]
		]]],
	...
	"SekatskiiBeltraminelliMerliniExtensionO" -> {
		...
		"StatementFormulation" -> Function[{\[FormalT], \[FormalA], \[FormalB], \[FormalN], \[FormalX], \[FormalZ]},
			ForAll[{\[FormalA], \[FormalB], \[FormalN]}, Element[\[FormalA], Reals] && \[FormalA] > 0 && Element[\[FormalB], Reals] && Element[\[FormalN], Integers] && 1/4 >= \[FormalB] > 0 && \[FormalA] = Divide[Pi(2\[FormalN] + 1), 1 - 2\[FormalB]] && \[FormalN] <= 1/(4\[FormalB])-1,
			Equivalent[
			Inactive[Integrate][
				Exp[- \[FormalA] \[FormalT]]Log[Abs[Zeta[\[FormalB] + I \[FormalT]]]],
				{\[FormalT], 0, Infinity}]
...
DataTable["RiemannHypothesisFormulation", "Property"] = {
	...
	"RelationshipToRiemannHypothesis" -> {
		...
		"MathematicaOutputType" -> Function[StringReplace[#, {
			...
			"Extension" -> "generalization of the Riemann hypothesis based on the width of the zero\[Hyphen]free region",
